...
CREATE_TABLE_TEXT = """
    CREATE TABLE IF NOT EXISTS payment_for_update (
...
INSERT_PAYMENT = "INSERT INTO payment_for_update (botToken, accountId, currency, amount, title, content, referenceCode, smsUniqueCode, remitter) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
SELECT_PAYMENT = "SELECT * FROM payment_for_update WHERE accountId = %s AND smsUniqueCode = %s"

...
INSERT_PAYMENT = "INSERT INTO payment_for_update (botToken, accountId, currency, amount, title, content, referenceCode, smsUniqueCode, remitter) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"
SELECT_PAYMENT = "SELECT * FROM payment_for_update WHERE accountId = ? AND smsUniqueCode = ?"
